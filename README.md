...
```sh
pipx install https://github.com/utsavanand/duckterm/releases/download/v0.4.50/duckterm-0.4.50-py3-none-any.whl
duckterm serve
```
...
[DuckTerm-0.4.50-macos-arm64.zip](https://github.com/utsavanand/duckterm/releases/download/v0.4.50/DuckTerm-0.4.50-macos-arm64.zip),
