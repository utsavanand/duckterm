...
```sh
pipx install https://github.com/utsavanand/duckterm/releases/download/v0.4.48/duckterm-0.4.48-py3-none-any.whl
duckterm serve
```
...
[DuckTerm-0.4.48-macos-arm64.zip](https://github.com/utsavanand/duckterm/releases/download/v0.4.48/DuckTerm-0.4.48-macos-arm64.zip),
