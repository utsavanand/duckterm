...
type Tab = "timeline" | "terminal" | "diff" | "checkpoints" | "notes";
          ...
          {(
            [
              ...
              ...(session.worktreePath || session.branch
                ? (["diff"] as Tab[])
                : []),
              // Terminal needs a PTY Duckterm owns (the in-process launch
              // path: in_terminal:false, or a worktree launch). Sessions in
              // the user's own terminal run elsewhere — nothing to attach to.
